async function checkAgent() {
  try {
    ...
    console.log(`\n📋 Found ${agents.length} agent definitions with agent.def.v1 schema`);
    
    for (const agent of agents) {
      console.log(`\n========================================`);
      console.log(`Agent: ${agent.title} (${agent.id})`);
      ...
      console.log('Context structure:', JSON.stringify(fullAgent.context, null, 2));
    }
  } catch (error) {
