# RCRT Visual Agent Builder System Design - REFERENCE ONLY

> **⚠️ NOTE**: This is the original design document. The current implementation is simpler and located in `rcrt-visual-builder/apps/builder/`.
